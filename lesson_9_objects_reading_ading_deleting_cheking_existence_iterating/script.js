...
//     password: 'qwerty',
//     'registration date': '01.01.2024', // если есть пробел или тире в кавычках - нужн использовать тире - иначе будет ошибка
...
// console.log(user['last-auth']) // Этим когом можно добыть значение по названию любого свойства, а названия, содержащие пробел или дефис - только этим 
...
// проверка на наличие свойсва по названию
